...
<body>
  ...
  ?>
	<div id = "content">
		...
		<div class="alert alert-info"><center><h3>ENROLLED STUDENTS</h3></center></div> 
		<?php 
		...
		<table id = "table" class="table table-bordered">
          ...
          <th hidden="">Section</th>
			...
			<tbody>
				...
				$query = mysqli_query($conn, "SELECT * FROM `student` where Status ='Enrolled'") or die(mysqli_error());
