...
<html lang="en">
	<head>
		<title>APCBA_Rizal RECORD MANAGEMENT SYSTEM</title>
		<meta charset = "utf-8" />
...
<body>
	<nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
		<div class="container-fluid">
			<label class="navbar-brand">APCBA_Rizal RECORD MANAGEMENT SYSTEM</label>
		</div>
	</nav>
	<div class="col-md-8">
		...
		<div class="panel panel-default">
			<div class="panel-body alert-success" >
				...
				<table id="table" class="table table-bordered">
					...
					<tbody>
						<?php
							$query = mysqli_query($conn, "SELECT * FROM `student` WHERE `id` = '$_GET[student]'") or die(mysqli_error());
	...
	<div class="col-md-4">
		<div class="panel panel-primary" style="margin-top:20%;">
			...
			<div class="panel-body">
				...
				<hr style="border-top:1px dotted #ccc;"/>
				<h4>Year & Section: <label class="pull-right"><?php echo $fetch['yr_sec']?></label></h4>
				<hr style="border-top:1px dotted #ccc;"/>
				<h3>File</h3>
				<form method="POST" enctype="multipart/form-data" action="save_file.php?student=<?php echo $fetch['id']?> ?>">
	...
	<div id = "footer">
		<label class = "footer-title">&copy; APCBA_Rizal RECORD MANAGEMENT SYSTEM <?php echo date("Y", strtotime("+8 HOURS"))?></label>
	</div>
